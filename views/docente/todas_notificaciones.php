...
<div class="container py-4">
    <div class="d-flex justify-content-between align-items-center mb-4">
        ...
        <a href="index.php?controller=Docente&action=dashboard" class="btn btn-outline-primary">
                        ...
                        <li class="list-group-item <?php echo $notificacion['leida'] ? '' : 'bg-light'; ?>">
                            <div class="d-flex justify-content-between">
                                ...
                                <?php if (!$notificacion['leida']): ?>
                                    <div class="ms-3">
                                        <a href="index.php?controller=Docente&action=marcarNotificacionLeida&id=<?php echo $notificacion['id']; ?>" class="btn btn-sm btn-outline-success">
